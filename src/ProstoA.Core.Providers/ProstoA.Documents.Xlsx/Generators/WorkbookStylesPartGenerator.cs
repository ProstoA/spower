    ...
    internal sealed class WorkbookStylesPartGenerator {
        public WorkbookStylesPart Do(WorkbookPart workbookPart, params XlsxCellStyle[] styles) {
            var fonts = styles.Select(x => new Font(
                Map(x.FontStyle),
                new FontSize { Val = x.FontSize },
                new Color { Rgb = x.FontCollorRgb }, //{Theme = 1U}
                new FontName { Val = x.FontFamily },
            ...
            var fills = new[] {
                ...
                : new Fill(new PatternFill(
                        new ForegroundColor { Rgb = x.Fill.FillForegroundColorArgb }, //{Theme = 1U}
                        new BackgroundColor { Rgb = x.Fill.FillBackgroundColorArgb } //{Theme = 1U}
                    ) {
